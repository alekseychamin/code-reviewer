...
public static class ReviewPromptGuardrails
{
    public const string FactualReviewGuardrails = """
        ...
        - Do not invent DTO/read-model nullability findings from cache emptiness alone. Emit a Risk only when the shown changed code couples non-nullable declarations, serialization, Excel/export, or string operations to those properties without a visible guarantee they are set before use in this flow.
